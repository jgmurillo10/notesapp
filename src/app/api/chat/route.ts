...
const cfp = `
  ...
  You will submit call for proposals talks for a javascript international conference talk.
  You should create a proposal with title and abstract for a Javascript conference.
