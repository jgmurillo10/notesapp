...
export const Chat = ({ role }: { role: string }) => {
  ...
  return (
    <div className="py-16">
      <div className="mx-auto w-full flex flex-col stretch border border-slate-300 rounded">
        ...
        <div className="min-h-[50vh]">
          <div className="flex flex-wrap">
            <p className="basis-full text-center my-4">
              <span className="p-2 mx-auto bg-slate-100 dark:bg-slate-800 dark:text-slate-300 rounded-md">
                Today
              </span>
            </p>
            <p className="p-2 mx-auto bg-slate-100 dark:bg-slate-800 dark:text-slate-300 rounded-md">
        ...
        >
          <label className="flex-1">
            <input
              ...
              className="w-full bottom-0 border border-gray-300 focus:ring-4 focus:ring-blue-300 rounded-l text-black"
              value={input}
